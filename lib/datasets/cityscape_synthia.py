...
class cityscape_synthia(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'cityscape_synthia_' + image_set)
        self._year = '2007'
        self._image_set = image_set
        self._devkit_path = cfg.DATASETS.CITYSCAPE_SYNTHIA
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__',  # always index 0
                         'car', 'bus', 'motorcycle', 'bicycle', 'person', 'rider')
...
if __name__ == '__main__':
    d = cityscape_synthia('train', '2007')
    res = d.roidb
