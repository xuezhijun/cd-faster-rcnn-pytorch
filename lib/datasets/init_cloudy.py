...
class init_cloudy(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'init_cloudy_' + image_set)

        self._year = '2007'
        self._image_set = image_set
        self._devkit_path = cfg.DATASETS.INIT_CLOUDY
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__', # always index 0
                         'car', 'speed limit sign', 'person')
    ...
    def _load_pascal_annotation(self, index):
        ...
        Some images contain classes which are not included in self._classes.
