...
def parse_args():
    ...
    parser.add_argument('--LA_ATT', dest='LA_ATT',
                        help='whether use local attention',
                        action='store_true')
    parser.add_argument('--MID_ATT', dest='MID_ATT',
                        help='whether use middle attention',
                        action='store_true')
    ################################################################################
    ...
    parser.add_argument('--fc', dest='fc',
                        help='whether use FC vector for CORAL Loss',
                        action='store_true')
    parser.add_argument('--cv', dest='cv',
                        help='whether use CV vector for CORAL Loss',
                        action='store_true')
    ################################################################################
    ...
    parser.add_argument('--cd_method', dest='cd_method',
                        help='which method to be used for demo',
...
def set_dataset_args(args, test=False):
    if not test:
        ...
        if args.dataset == 'pascal_voc':
            ...
            args.imdb_name = 'sim10k_cycle_train'  ###### sim10k_cycle ######
            ...
            args.imdb_name = 'cityscape_car_train'  ###### cityscape_car ######
            args.imdbval_name = 'cityscape_car_val'
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']

        elif args.dataset == 'cityscape_synthia':
            args.imdb_name = 'cityscape_synthia_train'  ###### cityscape_synthia ######
            args.imdbval_name = 'cityscape_synthia_train'
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']
        ...
        elif args.dataset == 'synthia_cycle':
            args.imdb_name = 'synthia_cycle_train'  ###### synthia_cycle ######
            args.imdbval_name = 'synthia_cycle_train'
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']
